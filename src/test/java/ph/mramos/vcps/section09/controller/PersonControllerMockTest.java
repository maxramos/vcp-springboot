...
@WebMvcTest(PersonController.class) // 'controllers' attribute can be left blank then only @Controller, @ControllerAdvice, WebMvcConfigurer, etc. will be loaded from where @SpringBootApplication is located (including sub packages).
