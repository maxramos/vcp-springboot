...
//	@Pointcut("execution(public ph.mramos.vcps.section09.entity.Person ph.mra*.vcps..*Service.find*(int, ..) throws ph.mramos.vcps.section09.service.PersonIdNotFoundException)")
